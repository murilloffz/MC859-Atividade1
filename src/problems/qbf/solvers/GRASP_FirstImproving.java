 ...
 */
public class GRASP_FirstImproving extends AbstractGRASP<Integer> {

    /**
     * Constructor for the GRASP_QBF_FIRST_IMPROVING class. An inverse QBF objective function is
     ...
     */
    public GRASP_FirstImproving(Double alpha, Integer time, String filename) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GRASP_FirstImproving grasp = new GRASP_FirstImproving(0.2, 1800000, "instances/kqbf/kqbf040");
