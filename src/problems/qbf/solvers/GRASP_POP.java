 ...
 */
public class GRASP_POP extends AbstractGRASP<Integer> {

    /**
     * Constructor for the GRASP_POP class. An inverse QBF objective function is
     ...
     */
    public GRASP_POP(Double alpha, Integer time, String filename) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GRASP_POP grasp = new GRASP_POP(0.2, 1800000, "instances/kqbf/kqbf040");
